...
namespace KletterWetter.Controllers
{
    public partial class WeatherDataController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public WeatherDataController Actions { get { return MVC.WeatherData; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "WeatherData";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "WeatherData";
        [GeneratedCode("T4MVC", "2.0")]
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_WeatherDataController : KletterWetter.Controllers.WeatherDataController
    {
        public T4MVC_WeatherDataController() : base(Dummy.Instance) { }

        [NonAction]
        partial void TableDataOverride(T4MVC_System_Web_Mvc_ActionResult callInfo);

        [NonAction]
        public override System.Web.Mvc.ActionResult TableData()
        {
